...
package hello.spring.hibernate1.service;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import hello.spring.hibernate1.domain.City;
import hello.spring.hibernate1.domain.Hotel;
import hello.spring.hibernate1.domain.Rating;
import hello.spring.hibernate1.domain.RatingCount;
import hello.spring.hibernate1.domain.Review;
import hello.spring.hibernate1.domain.ReviewDetails;
